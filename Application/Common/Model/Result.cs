...
namespace Application.Common.Model
{
    public class Result<TValue> where TValue : class
    {
        ...
        {
            _errors?.AddRange(validationResult.ValidationItems.Where(v => v.ValidationSeverity == ValidationSeverity.Error).Select(v => ValidationResultItem.FormValidationResultItem(v)));
        }
